            ...
            return(<>
              <div className='Card'>
                  ...
                  <div className='fourth-row'>
                      ...
                      style={{marginLeft: '.5rem', width: 'max-content', backgroundColor:'lightskyblue', borderRadius: '.3rem', color:' white', border: 'none'}}>Rent now</button>
                  </div>
              </div>
            </>)
        })}
